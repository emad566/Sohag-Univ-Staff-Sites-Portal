...
<div class="panel panel-default">
    <div class="panel-heading">{{ trans('main.researchCreateHead') }}</div>
    <div class="panel-body panelBodyForm">
        <form id='CreateUser' class='CreateUser form-horizontal panelForm' method='POST' action="{{ route('researchs.store', []) }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group{{ $errors->has('department') ? ' has-error' : '' }}">
                ...
                <input value="{{ old('department') }}" type="text" name="department" required class="form-control name" id="department" placeholder="{{ trans('main.answerH-department') }} *">
            ...
            <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                ...
                <textarea required name="content" id="content" class="form-control content editor" placeholder="{{ trans('main.QesReq') }} *">{{ old('content') }}</textarea>
