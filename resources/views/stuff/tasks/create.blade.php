...
<div class="panel panel-default">
    <div class="panel-heading">{{ trans('main.taskCreateHead') }}</div>
    <div class="panel-body panelBodyForm">
        <form id='CreateUser' class='CreateUser form-horizontal panelForm' method='POST' action="{{ route('tasks.store', []) }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <input value="{{ old('fullDegree') }}" type="number" name="fullDegree" required class="form-control fullDegree"  id="fullDegree" placeholder="{{ trans('main.fullDegree') }}">
